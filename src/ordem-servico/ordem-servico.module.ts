...
} from './infrastructure/notificacao/sqs-notificacao-orcamento.gateway';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: NOTIFICACAO_ORCAMENTO_GATEWAY,
      useClass: SqsNotificacaoOrcamentoGateway,
    },
  ],
})
