...
function criarGrupo(linhas: { quantidade: number; valorUnitario: number }[]): GrupoOrcamento {
...
describe('Orcamento', () => {
  ...
  it('criadoEm deve ser preenchido automaticamente', () => {
    ...
    expect(orcamento.criadoEm.getTime()).toBeGreaterThanOrEqual(antes.getTime());
