...
class ProblemaRelatadoDto {
  @ApiProperty({
    description: 'Descrição do problema ou sintoma em texto livre',
  })
  @IsString()
  descricao: string;
}
...
class ServicoSolicitadoDto {
  ...
  @ApiPropertyOptional({
    description:
      'Contexto adicional do cliente (ex: "última troca há 10.000 km")',
  })
  @IsOptional()
  @IsString()
  observacao?: string;
...
export class AbrirOrdemServicoDto {
  @ApiPropertyOptional({
    description: 'ID do cliente que solicita o atendimento',
  })
  @IsOptional()
  @IsString()
  clienteId?: string;
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Dados do cliente para abertura direta da OS quando clienteId não for informado',
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => ClienteAberturaDto)
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Dados do veículo para abertura direta da OS quando veiculoId não for informado',
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => VeiculoAberturaDto)
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Problemas relatados em texto livre (ao menos um entre este e servicosSolicitados)',
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Serviços do catálogo solicitados pelo cliente (ao menos um entre este e problemasRelatados)',
  })
  @IsOptional()
  @IsArray()
  @ValidateNested({ each: true })
  ...
  @ApiPropertyOptional({
    description: 'Notas internas da oficina (não visíveis ao cliente)',
  })
  @IsOptional()
  @IsString()
