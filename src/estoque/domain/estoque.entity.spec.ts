...
describe('Estoque', () => {
  ...
  describe('reconstituir()', () => {
    it('deve reconstituir estoque com todos os dados', () => {
      ...
      const estoque = Estoque.reconstituir({ peca, quantidadeDisponivel: 20, quantidadeMinima: 3 });
  ...
  describe('darEntrada()', () => {
    ...
    it('deve atualizar atualizadoEm', () => {
      ...
      jest.useRealTimers();
      expect(estoque.atualizadoEm.getTime()).toBeGreaterThanOrEqual(antes.getTime());
    });
  });
