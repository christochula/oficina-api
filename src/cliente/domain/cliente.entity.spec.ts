...
describe('Cliente', () => {
  describe('criar()', () => {
    ...
    it('rejeita CPF inv?lido no dom?nio', () => {
      expect(() =>
        Cliente.criar({
          tipoDoc: TipoDocumento.CPF,
          numeroDoc: '111.111.111-11',
          nome: 'Cliente',
    ...
    it('rejeita CNPJ inv?lido no dom?nio', () => {
      expect(() =>
        Cliente.criar({
          tipoDoc: TipoDocumento.CNPJ,
          numeroDoc: '11.111.111/1111-11',
          nome: 'Empresa',
  ...
  describe('atualizar()', () => {
    ...
    it('deve atualizar atualizadoEm ao atualizar', () => {
      ...
      jest.useRealTimers();
      expect(cliente.atualizadoEm.getTime()).toBeGreaterThanOrEqual(
        antes.getTime(),
      );
    });
