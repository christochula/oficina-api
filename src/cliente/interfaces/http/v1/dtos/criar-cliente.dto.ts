...
import { IsValidCnpj } from '../../../../../shared/http/validators/cnpj.validator';
import { IsValidCpf } from '../../../../../shared/http/validators/cpf.validator';
...
export class CriarClienteDto {
  ...
  @IsString()
  @ValidateIf((o: CriarClienteDto) => o.tipoDoc === TipoDocumento.CPF)
  @IsValidCpf()
  @ValidateIf((o: CriarClienteDto) => o.tipoDoc === TipoDocumento.CNPJ)
  @IsValidCnpj()
  numeroDoc: string;
