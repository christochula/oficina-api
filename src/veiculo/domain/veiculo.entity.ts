...
export class Veiculo extends EntidadeBase<VeiculoId> {
   ...
   */
  static criar(props: Omit<PropriedadesVeiculo, 'id' | 'criadoEm' | 'atualizadoEm'>): Veiculo {
   ...
   */
  static reconstituir(props: Required<Pick<PropriedadesVeiculo, 'id' | 'criadoEm' | 'atualizadoEm'>> & PropriedadesVeiculo): Veiculo {
    return new Veiculo(props);
  }
