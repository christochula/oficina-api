...
export class VeiculoController {
  ...
  async listar(@Query() paginacao: PaginacaoDto): Promise<RespostaPaginadaDto<Veiculo>> {
    const { itens, total } = await this.listarVeiculos.executar(paginacao.pagina, paginacao.porPagina);
