...
export class RegistrarServicoOficinaDto {
  @ApiProperty({ description: 'Nome do serviço (ex: "Troca de Óleo", "Alinhamento")' })
  @IsString()
  @MinLength(2)
  nome: string;
  ...
  @ApiPropertyOptional({ description: 'Categoria do serviço (ex: "Manutenção Preventiva", "Diagnóstico")' })
  @IsOptional()
  @IsString()
  categoria?: string;
}
